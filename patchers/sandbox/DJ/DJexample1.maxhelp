...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 206.0, 1250.5, 41.0, 22.0 ],
					"text" : "sel 32"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 206.0, 1216.0, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 291.0, 1323.0, 41.0, 22.0 ],
					"text" : "t i 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 1353.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 1285.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 291.0, 1353.0, 51.0, 22.0 ],
					"text" : "flush"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 291.0, 1385.0, 336.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 332.0, 1258.0, 29.5, 22.0 ],
					"text" : "> 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 304.0, 1228.0, 47.0, 22.0 ],
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 291.0, 1295.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 304.0, 1197.0, 79.0, 22.0 ],
					"text" : "MLE.midiKey"
				}
...
, 			{
				"box" : 				{
					...
					"pattrstorage" : "sdfgh",
					"presentation" : 1,
					"presentation_rect" : [ 519.0, 345.0, 100.0, 40.0 ]
				}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 761.0, 204.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1
					}
,
...
,
		"dependency_cache" : [ 			{
				"name" : "DJ.rotator2.maxpat",
				"bootpath" : "~/Documents/github/CML/MLE/patchers/sandbox/DJ",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
