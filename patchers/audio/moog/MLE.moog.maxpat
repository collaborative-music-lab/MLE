...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 431.0, 1253.0, 69.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 347.0, 1244.0, 51.0, 17.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 339.0, 1219.0, 48.0, 17.0 ],
					"text" : "delay 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 1200.0, 39.0, 17.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 383.0, 1179.0, 41.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 54.0, 1193.0, 29.5, 17.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.266670227050781, 874.0, 30.0, 17.0 ],
					"text" : "set $1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 138.0, 392.0, 50.0, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 572.0, 360.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 530.0, 404.0, 44.0, 22.0 ],
									"text" : "flush 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 530.0, 433.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 255.0, 390.0, 61.0, 22.0 ],
									"text" : "pack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 257.0, 345.0, 34.0, 22.0 ],
									"text" : "flush"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 283.0, 22.0, 29.5, 22.0 ],
									"text" : "t i b"
								}
...
,
									"patching_rect" : [ 416.5, 350.0, 104.5, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									"patching_rect" : [ 502.0, 300.0, 58.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 347.0, 262.0, 158.0, 22.0 ],
									"text" : "t l l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 280.0, 62.0, 29.5, 22.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 280.0, 93.0, 102.0, 22.0 ],
									"text" : "gate 2 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 357.0, 433.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 317.0, 22.0, 150.0, 20.0 ],
									"text" : "mono"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 283.0, -16.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 406.0, 239.68994140625, 50.0, 22.0 ],
									"text" : "67 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 280.0, 262.0, 50.0, 22.0 ],
									"text" : "target 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 363.0, 197.68994140625, 29.5, 22.0 ],
									"text" : "t l b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 35.0, 22.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 130.0, 138.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 202.0, 204.0, 56.0, 22.0 ],
									"text" : "midiflush"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 35.0, 153.0, 59.0, 22.0 ],
									"text" : "voices $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 119.0, 74.0, 102.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 165.5, 138.0, 55.5, 22.0 ],
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 165.5, 235.0, 61.0, 22.0 ],
									"text" : "zl.group 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "" ],
									"patching_rect" : [ 202.0, 168.0, 82.0, 22.0 ],
									"text" : "midiformat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 151.0, 266.0, 107.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 80.5, 308.0, 30.0, 30.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.666671752929688, 1239.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"VCAgate" : [ 0 ],
						"amoLFO" : [ 0.0 ],
						"ampADSR" : [ 0.052000001072884, 0.248841688036919, 0.509062588214874, 0.376071006059647 ],
						"filterADSR" : [ 0.0, 0.445396453142166, 0.0, 0.376071006059647 ],
						"filterADSRlevel" : [ 1.317073170731708 ],
						"filterFreq" : [ 1.630695413810028 ],
						"filterKey" : [ 1.889763779527559 ],
						"filterLFO" : [ 0.0 ],
						"filterRes" : [ 0.184615384615385 ],
						"glide" : [ 0.0 ],
						...
						"osc1_octave" : [ 1 ],
						"osc1_waveform" : [ 3 ],
						"osc1duty" : [ 0.263076923076923 ],
						"osc1gain" : [ 1.0 ],
						"osc2_waveform" : [ 3 ],
						"osc2detune" : [ 12.1 ],
						"osc2duty" : [ 0.422307692307692 ],
						"osc2gain" : [ 0.285035515814097 ],
						"osc2octave" : [ 1 ],
						"osc3-waveform" : [ 0 ],
						"osc3detune" : [ 0.090439265788163 ],
						"osc3duty" : [ 0.826153846153846 ],
						"osc3gain" : [ 0.0 ],
						"osc3octave" : [ 2 ],
						"pitchLFO" : [ 0.0 ],
						"pwmLFO" : [ 0.0 ],
						"slop" : [ 0.564706470318519 ]
					}
,
					"text" : "autopattr",
					"varname" : "u196021296"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 52.000015258789062, 1170.0, 115.0, 26.0 ],
					"presentation" : 1,
