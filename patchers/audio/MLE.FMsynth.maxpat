...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"env2s" : [ 0.0 ],
						"env2s[1]" : [ 0.0 ],
						"mod1depth" : [ 0.100000001490116 ],
						"mod1env" : [ 0, 0, 49, 1, 0, 0 ],
						"mod1harm" : [ 4.449999809265137 ],
						"mod2depth" : [ 0.600000023841858 ],
						"mod2env" : [ 0, 0, 22, 1, 0, 22 ],
						"mod2harm" : [ 1.669999957084656 ],
						"osc2e" : [ 0, 0, 19, 1, 0, 8 ]
					}
,
					"text" : "autopattr",
...
, 			{
				"box" : 				{
					...
					"text" : "env2 5 361.111121 0. 180.555561"
				}
