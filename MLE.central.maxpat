...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 892.0, 384.0, 71.0, 22.0 ],
					"text" : "pak 100 4 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 892.0, 420.0, 116.0, 22.0 ],
					"text" : "s localClockSettings"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 957.5, 342.0, 38.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.5, 173.5, 38.0, 20.0 ],
					"text" : "div"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1009.0, 321.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 181.0, 149.5, 33.0, 22.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.5, 143.0, 100.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1087.5, 350.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 189.0, 150.0, 20.0 ],
					"text" : "sync msg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1009.0, 342.0, 42.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 174.5, 173.5, 42.0, 20.0 ],
					"text" : "tempo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 897.5, 342.0, 38.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 108.5, 173.5, 38.0, 20.0 ],
					"text" : "beat"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 951.5, 321.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.5, 149.5, 34.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 897.5, 315.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 108.5, 149.5, 34.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1076.5, 321.0, 183.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 70.0, 189.0, 183.0, 22.0 ],
					"text" : "100 12 8"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.5, 114.0, 115.0, 27.0 ],
					"text" : "Sync Mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 617.0, 102.0, 41.0, 35.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 534.0, 103.0, 77.0, 22.0 ],
					"text" : "loadmess 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "link" ],
					"patching_rect" : [ 914.5, 245.0, 110.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.5, 119.0, 93.0, 22.0 ],
					"text" : "MLE.beatSync2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 655.0, 364.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 654.0, 542.0, 126.0, 22.0 ],
					"text" : "zmap 128 256 -12. -2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 654.0, 585.0, 200.0, 22.0 ],
					"text" : "pattrforward komp-regular[1]::thresh"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 334.0, 766.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 792.0, 71.0, 23.0 ],
					"text" : "bypass $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1052.0, 788.0, 34.0, 22.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 951.0, 785.0, 80.0, 22.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 951.0, 757.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 951.0, 728.0, 237.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 951.0, 662.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 951.0, 696.0, 94.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 655.0, 341.5, 77.0, 22.0 ],
					"text" : "loadmess 45"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 81.0, 174.0, 80.0, 13.0 ]
				}
...
,
					"patching_rect" : [ -22.5, 90.0, 89.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 215.0, 128.0, 81.0, 22.0 ],
					"text" : "delay~ 24000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 81.0, 138.0, 81.0, 22.0 ],
					"text" : "delay~ 24000"
				}
...
,
					"patching_rect" : [ 206.5, 769.0, 92.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 112.5, 805.5, 91.0, 23.0 ],
					"text" : "omx.peaklim~"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -280.0, -72.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 81.0, 438.0, 330.0, 121.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 188.0, 705.5, 30.0, 22.0 ],
					"text" : "*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.5, 705.5, 30.0, 22.0 ],
					"text" : "*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 112.5, 849.5, 75.0, 22.0 ],
					"text" : "dac~ 1 2 3 4"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../ianhattwick/Library/Application Support/Cycling '74/Max 8/Examples/effects/kompressor/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
